            ...
            <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="#home" class="navbar-brand"><h1 style="color: white; margin-top: -10px;">SIND<span style="color : #ffff37;">COCO</span></h1></a>
                    </div>
    ...
    <div class="slider">
        <div id="fawesome-carousel" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators indicatior2">
                ...
                <li data-target="#fawesome-carousel" data-slide-to="6"></li>
                <li data-target="#fawesome-carousel" data-slide-to="7"></li>
            </ol>
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                    <img src="img/bn/002.jpg" alt="Sider Big Image" width="100%" height="100%">
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <img src="img/bn/003.jpg" alt="Sider Big Image" width="100%" height="100%">
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <img src="img/bn/004.jpg" alt="Sider Big Image" width="100%" height="100%">
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <img src="img/bn/005.jpg" alt="Sider Big Image" width="100%" height="100%">
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <img src="img/bn/007.jpg" alt="Sider Big Image" width="100%" height="100%">
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <img src="img/bn/008.jpg" alt="Sider Big Image" width="100%" height="100%">
                    <div class="carousel-caption">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="about-text wow fadeInRight">
                    <h3>Bem-vindo ao Sindcoco</h3>
                    <p>Temos como função defender os seus interesses e direitos profissionais e de sua cidadania.</p>
                    <a href="/sobre/" class="btn btn-read-more">Ver mais >></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <!--	<div class="col-sm-4">
                    <div class="progress-bar-custom wow fadeInLeft">
                        ...
                        <div class="text">
                            <h4>
                                    Atuar em prol do desenvolvimento das atividades da coconicultura,
                                    através do apoio e defesa dos produtores e de suas comunidades.
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="progress-bar-custom wow fadeInLeft">
                        ...
                        <div class="text">
                                <h4>
                                        Ser organização de referência nacional nas ações
        ...
        <div id="grid" class="clearfix">
            <center>
                <div class="teste" style="width: 50%; ">
                    ...
                    <div class="embed-responsive embed-responsive-16" style="padding-bottom: 50%">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/3goeWbgT-Rk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br>
                    </div><br>
                    <div class="embed-responsive embed-responsive-16" style="padding-bottom: 50%">
...
<section id="blog" class="site-padding">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="title">
                    <h3>Ultimos  <span>Classificados</span></h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="single-footer">
                    <div class="footer-logo">
                        ...
                        <p>Fones: (81) 3224-0344/3224-2638</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3 ">
                <div class="single-footer">
                    ...
                    <a href="http://www.sococo.com.br">
                        <img src="/img/parceiros/002.jpg"  />
                    </a>
            ...
            <div class="col-sm-3 ">
                <div class="single-footer">
                    ...
                    <img src="/img/parceiros/parceiro03.jpg" width="100%" height="100%" />
                    <!--<li><img src="/img/project.png" alt="Reccent Project" /></li>
                    <li><img src="/img/project.png" alt="Reccent Project" /></li>
                    <li><img src="/img/project.png" alt="Reccent Project" /></li>
                    <li><img src="/img/project.png" alt="Reccent Project" /></li>-->
